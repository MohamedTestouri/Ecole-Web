...
class Comments
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity=tableformations::class, inversedBy="comments")
    ...
    public function getFormations(): ?tableformations
    {
        return $this->formations;
    }

    public function setFormations(?tableformations $formations): self
    {
