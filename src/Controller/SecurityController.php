...
class SecurityController extends AbstractController
{
    ...
    public function oubliPass(Request $request, UsersRepository $users, \Swift_Mailer $mailer, TokenGeneratorInterface $tokenGenerator): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // On génère l'e-mail
            $message = (new \Swift_Message('Recuperer votre mot de passe'))
                ...
                ->setBody(
                    $this->renderView(
                        'security/email.html.twig', ['token' => $user->getActivation()]
                    ),
                    'text/html'
                )
            ;
    ...
    public function resetPassword(Request $request, string $token, UserPasswordEncoderInterface $passwordEncoder)
    {
        ...
        $user = $this->getDoctrine()->getRepository(Users::class)->findOneBy(['activation' => $token]);
